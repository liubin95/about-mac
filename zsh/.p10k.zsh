# Generated by Powerlevel10k configuration wizard on 2024-05-27 at 13:35 CST.
...
() {
  ...
  # add by liubin
  function prompt_k8s_env() {
    p10k segment -f 208 -t "k8s, $KUBE_ENV"
  }
  typeset -g POWERLEVEL9K_K8S_ENV_SHOW_ON_COMMAND='kubectl|k_switch|flux'
  # add by liubin
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='#4C4F69'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=208

  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=009
